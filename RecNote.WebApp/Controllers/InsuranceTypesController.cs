...
namespace RecNote.WebApp.Controllers
{
    public class InsuranceTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "InsuranceTypeId,InsuranceDescription")] InsuranceType insuranceType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "InsuranceTypeId,InsuranceDescription")] InsuranceType insuranceType)
        {
            if (ModelState.IsValid)
            {
