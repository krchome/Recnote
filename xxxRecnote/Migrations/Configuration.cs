...
namespace Recnote.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Recnote.Models.ApplicationDbContext>
    {
        ...
        bool AddUserAndRole(Recnote.Models.ApplicationDbContext context)
        {
            IdentityResult ir;
        ...
        protected override void Seed(Recnote.Models.ApplicationDbContext context)
        {
